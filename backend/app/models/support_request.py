...
class SupportRequest(Base):
    ...
    guest_id = Column(
        UUID(as_uuid=True), ForeignKey("guests.guest_id"), nullable=False, index=True
    )

    # Request Details
    category = Column(
        Enum(RequestCategory), default=RequestCategory.UNKNOWN, nullable=False
    )
    ...
    )  # Can be assigned to specific planner/staff
